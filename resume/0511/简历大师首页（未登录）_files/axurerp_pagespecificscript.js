...
var PageName = '简历大师首页（未登录）';
var PageId = '5c7051e5db9a4d22a1e3cd6b3b6dd4dd'
var PageUrl = '简历大师首页（未登录）.html'
document.title = '简历大师首页（未登录）';
var PageNotes = 
{
"pageName":"简历大师首页（未登录）",
...
if (true) {
	...
	self.location.href="密码恢复（邮件验证）.html" + GetQuerystring();
