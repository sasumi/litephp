...
<div style="float:left; width:530px; margin-right:20px;">
	...
	<p>
		优秀的你，需要一份更优秀的简历。创造好机会，从创建好简历开始。 <a href="guide.php">马上行动</a>
	</p>
	
	<form action="guide.php">
		<input type="submit" value="马上去做（几分钟完成）"/>
	</form>
...
<div>
	<form action="register.php"><input type="submit" value="马上注册，创建简历"/></form>
	
	<form action="login.php">
		<input type="text" placeholder="输入邮箱或手机号"/><br/>
		<input type="text" placeholder="输入密码" id=""/><br/>
		<input type="checkbox" name="" id="remeber"/><label for="remeber">记住登录状态</label>   
		<a href="findpassword.php">忘记密码</a><br/>
		<input type="submit" value="登录"/>
	</form>
	
	<p>
		已精选<b>234</b>份优秀简历，<a href="demo.php">去看看</a>
	</p>
	<p>
