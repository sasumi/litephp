...
<div>
	<?php if(!Access::init()->checkLogin()):?>
	<form action="<?php echo url('user/register')?>"><input type="submit" value="马上注册，创建简历"/></form>
	<form action="<?php echo url('user/login')?>" method="post">
		<input type="text" name="name" placeholder="输入邮箱或手机号"/><br/>
		<input type="text" name="password" placeholder="输入密码" id=""/><br/>
