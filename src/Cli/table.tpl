 ...
 * @method static {$class_name}|Query setQuery($query = null, ...$var2)
 * @method Query getQuery()
 * @method static \Exception transaction($handler)
 * @method \PDOStatement execute()
 * @method static {$class_name}|Query find($statement = '', $var = null, ...$var2)
 * @method {$class_name}|Query where($statement = '', $var = null, ...$var2)
 * @method {$class_name}|Query whereOnSet($statement = '', $var = null, ...$var2)
 * @method {$class_name}|Query whereLikeOnSet($statement = '', $var = null, ...$var2)
 * @method {$class_name}|Query order($statement='')
 ...
 * @method {$class_name}[]|array all($as_array = false, $unique_key = '')
 * @method {$class_name}|Query|array|null one($as_array = false)
 * @method array column($key)
 * @method mixed|null ceil($key = null)
 * @method bool chunk($size = 1, $handler, $as_array = false)
 * @method int count()
 * @method {$class_name}[]|null paginate($page = null, $as_array = false, $unique_key = '')
